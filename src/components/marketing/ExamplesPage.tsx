    ...
    <div className="min-h-screen bg-slate-950 font-sans overflow-x-hidden">
      ...
      <div className="text-center py-14 px-6 relative">
        ...
        <motion.p initial={{ opacity:0, y:12 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5, delay:0.14 }}
          ...
          Every interaction below is the kind NexCourse includes in a generated course — you can edit them before you publish.
          Browse them as slides inside an eLearning player.
        </motion.p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <motion.div initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5, delay:0.4 }}
          ...
          <p className="text-slate-500 text-sm mb-2">These interaction types are included in generated courses — you can edit them before you publish.</p>
