...
export const DraftCoursesPanel: React.FC<Props> = ({
  ...
  isAuthenticated, currentCourseTitle, onSave, onLoad, onDelete, onReplace, saveMessage,
}) => {
                ...
                {saveMessage && (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      saveMessage.startsWith('✓') || saveMessage.includes('saved')
                  ...
                  >
                    {saveMessage.includes('saved') ? <CheckCircle2 className="w-4 h-4 shrink-0" /> : <AlertCircle className="w-4 h-4 shrink-0" />}
                    {saveMessage}
                  </motion.div>
                )}
              </AnimatePresence>
