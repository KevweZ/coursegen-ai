...
export default function TabbedContentVertical({ tabs = [], title, theme = 'dark' }: Props) {
  ...
  return (
    <div className="w-full flex flex-col gap-3 select-none">
      ...
      <div className="flex gap-4 h-full min-h-[280px]">
        ...
        {/* Content Panel */}
        <div className={cn('flex-1 relative overflow-hidden rounded-2xl border', isLight ? 'bg-white border-slate-200 shadow-sm' : 'bg-slate-800/60 border-slate-700')}>
